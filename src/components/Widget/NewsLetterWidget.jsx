...
export default function NewsLetterWidget({ title, subTitle }) {
  return (
    <div className="cs_newsletter cs_style_1">
      <h2 className="cs_newsletter_title  cs_fs_22 cs_mb_9">
        {title}
      </h2>
      <p className="cs_newsletter_subtitle cs_mb_26"  style={{color:'#444f60'}}>{subTitle}</p>
      <form action="/" className="cs_newsletter_form position-relative">
        <input
          type="email"
          className="cs_newsletter_input  cs_fs_14 cs_rounded_5 border-0 w-100 cs_pt_10"
